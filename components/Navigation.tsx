          ...
          <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-4">
                {loading ? (
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 bg-primary text-white px-4 py-2 rounded-lg font-semibold hover:bg-primary-dark transition-colors duration-200"
                  >
            ...
            <div className="lg:hidden flex items-center space-x-2">
              {!loading && !isAuthenticated && (
                <button
                  onClick={openLoginModal}
                  className="flex items-center space-x-1 bg-primary text-white px-3 py-2 rounded-lg text-sm font-semibold hover:bg-primary-dark transition-colors duration-200"
                >
                  <LogIn className="w-4 h-4" />
                  <span>Sign In</span>
                </button>
